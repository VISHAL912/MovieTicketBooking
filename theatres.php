	...
	if(isset($_REQUEST['delid']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		$qry_duplicate="Select Theatre_Name ,Movie_Name ,Location,time1,time2 from theatres
		...
		{
			$qry="INSERT INTO theatres (Theatre_Name ,Movie_Name ,Location,time1 ,time2 ) 
			VALUES ('$theatre','$movie','$location','$time1','$time2')";
...
<?php
include('dbcon.php');
$qry="select Theatre_id,Theatre_Name ,Movie_Name ,Location,time1 ,time2 FROM theatres";
