...
<?php
	...
	$qry_theatreID_BookingID= "update bookings,theatres set thetre_id=theatres.Theatre_id  where bookings.location = theatres.Location AND bookings.theatre=theatres.Theatre_Name;";
    mysqli_query($con,$qry_theatreID_BookingID);

	
	if(mail($_SESSION['email'],'PCCOE MULTIPLEX','Movie: '.$_SESSION['movie_n']."\n".'Showtime: '.$_SESSION['timer']."\n".'Theatre: '.$_SESSION['theatre_n'].",".$loc."\n".'Seats: '.json_encode($_SESSION['seatings'])."\n"."Your Ticket Booked."))
{
}
else
{
...
<li><img src="images/logoo.png" style="padding-left:5px;padding-right:10px;padding-top:10px;float:left;height:35px;width:250px"></li>
